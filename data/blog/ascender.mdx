...
<blockquote class="twitter-tweet">
  <p lang="ja" dir="ltr">
    ...
    <a href="https://t.co/2qkiKWlvme">https://t.co/2qkiKWlvme</a>
  </p>
  &mdash; mamas (@mamas16k){' '}
  <a href="https://twitter.com/mamas16k/status/1564583222377586693?ref_src=twsrc%5Etfw">
    August 30, 2022
  </a>
...
また, 現在も継続的に開発・保守をを行っておりますので, 新しい機能の要望や改善点などがあれば気軽に issue や pull request を作成頂ければと思います.
