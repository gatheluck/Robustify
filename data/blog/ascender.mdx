...
- Python を用いた研究プロジェクト向けの GitHub リポジトリテンプレート[Ascender](https://github.com/cvpaperchallenge/Ascender)を公開しました.
...
本記事では [Ascender](https://github.com/cvpaperchallenge/Ascender) の機能と使い方について簡単に紹介します.
...
[Ascender](https://github.com/cvpaperchallenge/Ascender) では開発環境による影響を極力小さくするために, Docker コンテナ内で開発をすることを推奨しています.
そのため, [Ascender](https://github.com/cvpaperchallenge/Ascender) で開発を始める準備として,
[Docker](https://www.docker.com/), [Docker Compose](https://github.com/docker/compose), [NVIDIA Container Toolkit (nvidia-docker2)](https://github.com/NVIDIA/nvidia-docker) をインストールします.
