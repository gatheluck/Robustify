...
[Ascender](https://github.com/cvpaperchallenge/Ascender) recommends that you develop in a Docker container to minimize the influence of the development environment.
Therefore, we will explain how to install [Docker](https://www.docker.com/),
[Docker Compose](https://github.com/docker/compose) and [NVIDIA Container Toolkit (nvidia-docker2)](https://github.com/NVIDIA/nvidia-docker) in preparation for starting development with [Ascender](https://github.com/cvpaperchallenge/Ascender).
