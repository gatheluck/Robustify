...
これをうけて, macOS 等の環境で Docker を無料で使用するためには Docker Desktop 代替手段を使うことが必要となりました.

Docker Desktop 代替として使用出来るものは [minikube](https://github.com/kubernetes/minikube),
[Rancher Desktop](https://rancherdesktop.io/), [Lima](https://github.com/lima-vm/lima) など
複数ありますが, セットアップの簡潔さという尺度では現状では [Colima](https://github.com/abiosoft/colima) が最も良いと思います.
